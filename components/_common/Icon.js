...
const Icon = ({ name, fill, width, bottomColor, height, viewBox, theme, ...otherProps }) => {
  const graphics = {
    home: {
      width: 24,
      height: 20,
      viewBox: '0 0 24 20',
      content: <Path fill={fill || theme.white} d="M9.6 19.55v-6.9h4.8v6.9h6v-9.2H24L12 0 0 10.35h3.6v9.2z" />
    },
    search: {
      width: 23,
      height: 23,
